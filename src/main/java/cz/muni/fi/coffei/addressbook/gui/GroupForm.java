...
public class GroupForm extends JDialog {
	...
	public GroupForm(Group group) {
		...
		DefaultListModel<BoolWrapper<Person>> listModel = new DefaultListModel<>();
		listModel.addElement(new BoolWrapper<Person>(p1));
		listModel.addElement(new BoolWrapper<Person>(p2, true));
		listModel.addElement(new BoolWrapper<Person>(p3, true));
		listModel.addElement(new BoolWrapper<Person>(p4));
		listModel.addElement(new BoolWrapper<Person>(p5));
		...
		panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
		{
			...
			textPane.setPreferredSize(new Dimension(12, 12));
